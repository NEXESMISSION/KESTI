  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess(true)
        setError(null)
        trackSignupSuccess('email', data.userId)
          ...
          <div className="flex-1 flex items-center justify-center p-6 md:p-12">
            <div className="w-full max-w-md">
              ...
              <button
                ...
                className="w-full py-4 bg-white border-2 border-gray-300 text-gray-700 rounded-xl font-bold text-base hover:bg-gray-50 hover:border-gray-400 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-3 shadow-sm"
              >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">أو التسجيل بالبريد الإلكتروني</span>
                </div>
              </div>
