...
export default function Suspended() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 p-4" dir="rtl">
      <Head>
        <title>الحساب معلق - Kesti Pro</title>
      </Head>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-6">
              <p className="text-red-800 font-medium text-center leading-relaxed">
                {suspensionMessage}
              </p>
            </div>
            ...
            <p className="text-gray-600 mb-6 text-center leading-relaxed">
              يرجى التواصل مع المسؤول أو الدعم الفني لاستعادة الوصول إلى حسابك.
            </p>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6 mb-6">
              ...
              {/* Email */}
              <div className="bg-white rounded-lg p-4 mb-3 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a href="mailto:support@kestipro.com" className="text-gray-900 font-semibold hover:text-blue-600 transition-colors">
              ...
              <div className="bg-white rounded-lg p-4 mb-3 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <a href="tel:+21653518337" className="text-gray-900 font-semibold hover:text-blue-600 transition-colors" dir="ltr">
                      +216 53 518 337
                    </a>
                  </div>
                </div>
              ...
              {/* WhatsApp */}
              <a 
                href="https://wa.me/21653518337?text=مرحبا، حسابي معلق وأحتاج مساعدة"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-lg p-4 flex items-center gap-3 transition-all hover:shadow-lg"
              >
      ...
      <div className="fixed top-0 right-0 w-96 h-96 bg-red-100/30 rounded-full blur-3xl -z-10"></div>
      <div className="fixed bottom-0 left-0 w-96 h-96 bg-orange-100/30 rounded-full blur-3xl -z-10"></div>
    </div>
  )
}
