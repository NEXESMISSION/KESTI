            ...
            <div className="bg-white rounded-3xl p-8 max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="space-y-4">
                ...
                <a href={`mailto:${contactInfo.email}`} className="flex items-center gap-4 p-5 bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl hover:scale-105 transition-transform group">
                  ...
                  <div className="flex-1 text-right">
                    <p className="text-sm font-semibold text-gray-600">بريد إلكتروني</p>
                    <p className="text-lg font-bold text-gray-900">{contactInfo.email}</p>
                  </div>
                </a>

                {/* Social Media */}
                <div className="pt-4 border-t-2 border-gray-200">
                  <p className="text-center text-sm font-bold text-gray-600 mb-4">تابعنا على</p>
                  <div className="flex gap-4 justify-center">
                    <a href={contactInfo.facebook} target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-blue-600 rounded-xl flex items-center justify-center text-3xl hover:scale-110 transition-transform">
                      <span className="text-white">👍</span>
                    </a>
                    <a href={contactInfo.instagram} target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-xl flex items-center justify-center text-3xl hover:scale-110 transition-transform">
                      <span className="text-white">📷</span>
                    </a>
                  </div>
                </div>
                ...
                {/* CTA Message */}
                <div className="bg-gradient-to-r from-secondary to-green-400 rounded-2xl p-6 text-center mt-6">
                  <p className="text-xl font-black text-gray-900">
                    🎉 ابدأ تجربتك المجانية لمدة 15 يوم!
                  </p>
                  <p className="text-sm text-gray-800 mt-2">
                    تواصل معنا الآن وسنفعل حسابك فوراً
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
              ...
              <div className="text-center md:text-right">
                <div className="flex items-center justify-center md:justify-start gap-3 mb-2 md:mb-3">
                  ...
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Kesti Pro</h3>
                </div>
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col gap-2 text-xs md:text-sm">
                  ...
                  <a href="/login" className="text-gray-400 hover:text-secondary transition py-1">تسجيل الدخول</a>
