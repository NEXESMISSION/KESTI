  ...
  return (
    <>
      <SEO 
        ...
        description="كيستي برو - النظام الأول في تونس لإدارة المبيعات والمخزون. يعمل على كل الأجهزة بدون تثبيت. تقارير تلقائية، حساب أرباح فوري، إدارة مخزون ذكية. جرب مجاناً 15 يوم! السعر: 19 د.ت/شهر فقط. مثالي للسوبرماركت، الصيدليات، المطاعم، المحلات. دعم واتساب فوري. Kesti Pro - Tunisia's #1 POS System."
      ...
      <div className="min-h-screen bg-white" dir="rtl">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <a href="#contact" className="text-gray-600 hover:text-gray-900 font-medium text-sm transition-colors">
                  تواصل معنا
                </a>
              </div>
              ...
              <div className="hidden md:flex items-center gap-3">
                {isLoggedIn ? (
                  <Link href="/pos" className="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all">
                    لوحة التحكم
                  </Link>
                ) : (
                  <>
              ...
              <div className="md:hidden py-4 border-t border-gray-200">
                <div className="space-y-1">
                  <a 
                    ...
                    className="block py-2 px-4 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg font-medium text-sm transition-colors"
                  >
                    المميزات
                  </a>
                  <a 
                  ...
                  <div className="pt-3 space-y-2 px-4">
                    {isLoggedIn ? (
                      <Link 
                        href="/pos" 
                        onClick={() => setMobileMenuOpen(false)} 
                        className="block text-center bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors"
                      >
                        لوحة التحكم
                      </Link>
                    ) : (
                      <>
                        <Link 
                          href="/login" 
                          onClick={() => setMobileMenuOpen(false)} 
                          className="block text-center bg-gray-100 hover:bg-gray-200 text-gray-900 px-4 py-2 rounded-lg font-medium text-sm transition-colors"
                        >
                          تسجيل الدخول
                        </Link>
                        <Link 
              ...
              <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                ...
                <div className="text-center lg:text-right animate-fadeIn">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
                    {isLoggedIn ? (
                      <Link href="/pos" className="bg-gray-900 text-white px-8 py-4 rounded-xl font-bold text-[17px] sm:text-[19px] hover:bg-gray-800 hover:scale-105 transition-all duration-300 shadow-lg">
        ...
        <section className="py-20 md:py-28 bg-gradient-to-br from-gray-50 via-white to-gray-100">
          <div className="container mx-auto px-4">
        ...
        <section id="problems" className="py-20 md:py-28 bg-gray-900">
          <div className="container mx-auto px-4">
            ...
            {/* First row - 3 items */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-5 max-w-5xl mx-auto mb-4 md:mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-5 justify-center max-w-4xl mx-auto">
              {problems.slice(3, 5).map((problem, idx) => (
                <div key={idx} className="bg-gray-800 rounded-2xl p-5 md:p-6 border border-gray-700 hover:border-red-500 hover:bg-gray-700 hover:-translate-y-2 transition-all duration-500 group cursor-pointer sm:w-[280px] md:w-[320px]">
                  <div className="text-[36px] md:text-[42px] mb-4 group-hover:scale-110 transition-transform duration-300">{problem.icon}</div>
                  <h3 className="font-bold text-white text-[16px] md:text-[18px] lg:text-[20px] mb-2 leading-[1.4]">{problem.title}</h3>
                  <p className="text-[14px] md:text-[15px] lg:text-[16px] text-gray-400 leading-[1.6]">{problem.desc}</p>
                </div>
        ...
        <section id="features" className="py-20 md:py-28 bg-white">
          <div className="container mx-auto px-4">
            ...
            {/* First row - 4 items */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 max-w-6xl mx-auto mb-4 md:mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-5 justify-center max-w-5xl mx-auto">
              {features.slice(4, 7).map((feature, idx) => (
                <div key={idx} className="bg-gray-50 rounded-2xl p-5 md:p-6 border border-gray-200 hover:border-gray-400 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group cursor-pointer sm:w-[250px] md:w-[280px]">
                  <div className="text-[36px] md:text-[42px] mb-4 group-hover:scale-110 transition-transform duration-300">{feature.icon}</div>
                  <h3 className="text-[16px] md:text-[18px] lg:text-[20px] font-bold text-gray-900 mb-2 leading-[1.4]">{feature.title}</h3>
                  <p className="text-[14px] md:text-[15px] lg:text-[16px] text-gray-600 leading-[1.6]">{feature.desc}</p>
                </div>
        ...
        {/* Footer - Merged with CTA gradient */}
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                <a href={contactInfo.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition">
                ...
                <a href={contactInfo.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition">
                ...
                <a href={`https://wa.me/${contactInfo.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition">
                  <svg className="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/></svg>
                </a>
              </div>
            </div>
